...
public class ListAdapterJobDailyVAS extends ArrayAdapter {
	...
	public ListAdapterJobDailyVAS(Context context, List<ModelListJobDailyVAS> list, String statusPublish) {
		super(context, R.layout.view_lv_daily_joblist, list);
...
//            LayoutInflater inflater =(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			...
			convertView = inflater.inflate(R.layout.view_lv_daily_joblist, null);
			holder.tgl = (TextView) convertView.findViewById(R.id.tglLvJobDailyVAS);
			holder.nama = (TextView) convertView.findViewById(R.id.namaLvJobDailyVAS);
