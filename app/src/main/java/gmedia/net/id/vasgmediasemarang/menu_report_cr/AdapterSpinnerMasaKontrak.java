...
public class AdapterSpinnerMasaKontrak extends ArrayAdapter {
	private List<ModelDropdownMasaKontrak> list;
	LayoutInflater inflater;
	private TextView nama, email;

	public AdapterSpinnerMasaKontrak(Activity context, int resourceID, int textviewId, List<ModelDropdownMasaKontrak> list) {
...
//            LayoutInflater inflater =(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            /*LayoutInflater inflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
			convertView = inflater.inflate(R.layout.view_spinner_masa_kontrak, null, true);
			nama = (TextView) convertView.findViewById(R.id.txtNamaMasaKontrak);
		}
		ModelDropdownMasaKontrak modelPIC = list.get(position);
