...
import gmedia.net.id.vasgmediasemarang.menu_job_daily_vas.ListAdapterJobDailyVAS;

public class AdapterSpinnerPIC extends ArrayAdapter {
	private List<MasterModelPIC> list;
	LayoutInflater inflater;
	private TextView nama, email;

	public AdapterSpinnerPIC(Activity context, int resourceID, int textviewId, List<MasterModelPIC> list) {
...
//            LayoutInflater inflater =(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            /*LayoutInflater inflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
			convertView = inflater.inflate(R.layout.view_spinner_pic, null, true);
			nama = (TextView) convertView.findViewById(R.id.txtNamaPIC);
			email = (TextView) convertView.findViewById(R.id.txtEmailPIC);
		}
		MasterModelPIC modelPIC = list.get(position);
		nama.setText(modelPIC.getNama());
		email.setText(modelPIC.getEmail());
		return convertView;
	}
